...
import { PERKS } from "@/constant/menu";
      ...
      <Container>
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
          ...
          <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
            Explore the powerful features and resources designed to empower,
            support, and connect women in Sierra Leone, from community forums
            and job opportunities to confidential legal support and a thriving
            marketplace.
          </p>
        </div>
      </Container>
